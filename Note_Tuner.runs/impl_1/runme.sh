...
HD_PWD='C:/Users/danny/OneDrive/Desktop/FPGA/Note_Tuner/Note_Tuner.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Note_tuner_top_level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Note_tuner_top_level.tcl -notrace
