...
HD_PWD='C:/Users/danny/OneDrive/Desktop/FPGA/Note_Tuner/Note_Tuner.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Note_tuner_top_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Note_tuner_top_level.tcl
