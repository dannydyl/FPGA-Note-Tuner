...
#set_property PACKAGE_PIN V16 [get_ports {reset1}]
...
#set_property PACKAGE_PIN L1 [get_ports {LED_busy}]
#set_property IOSTANDARD LVCMOS33 [get_ports {LED_busy}]


##7 segment display
#set_property PACKAGE_PIN W7 [get_ports {seg_display[6]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {seg_display[6]}]
#set_property PACKAGE_PIN W6 [get_ports {seg_display[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {seg_display[5]}]
#set_property PACKAGE_PIN U8 [get_ports {seg_display[4]}]
...
#set_property PACKAGE_PIN U5 [get_ports {seg_display[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {seg_display[2]}]
#set_property PACKAGE_PIN V5 [get_ports {seg_display[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {seg_display[1]}]
#set_property PACKAGE_PIN U7 [get_ports {debug}]
...
##USB-RS232 Interface
#set_property PACKAGE_PIN B18 [get_ports uart_tx_serial]
